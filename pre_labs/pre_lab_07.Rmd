...
```{r echo=FALSE}
census_api_key("d1835e9467ddf430519c3fd805b7e9d4364d94b1", install=TRUE)
```
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Answer** How do I work where they work?
