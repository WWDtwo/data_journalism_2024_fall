...
```{r}
gen2022 <- read.csv("/Users/wadedevinney/Downloads/Signed-2022-General-Election-State-Canvass-Certification.csv")
```
...
```{r}
gen2018 <- read.csv("/Users/wadedevinney/Downloads/General-Election-2018.csv")
```
...
```{r}
election_comparison <- gen2022 |>
  left_join(gen2018, by="County")
```
