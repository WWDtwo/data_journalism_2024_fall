...
# Sorry, I figured out how many libraries there are in R and I got a little carried away
library(tidyverse)
library(janitor)
library(dplyr)
library(lubridate)
...
```{r}
# Party registrations
new_registrations_2024 <- read.csv("data/new_registrations.csv")
new_registrations_2024 <- new_registrations_2024 |>
  clean_names()
```

```{r}
# Removals
banished_voters_2024 <- read_csv("data/banished_voters.csv")
banished_voters_2024 <- banished_voters_2024 |>
  clean_names()
```

```{r}
# Changes
registration_changes_2024 <- read.csv("data/registration_changes.csv")
registration_changes_2024 <- registration_changes_2024 |>
  clean_names()
```

```{r}
# Current registrations
active_voters_2024 <- read.csv("data/active_voters.csv")
active_voters_2024 <- active_voters_2024 |>
  clean_names()
```
