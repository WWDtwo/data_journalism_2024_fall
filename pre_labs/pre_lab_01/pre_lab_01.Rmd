...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **Answer** Last Name is a field, amount is a variable. Last name, if I had to guess, represents the surname of a person, and the amount is amount of money contributed
...
**Answer** The code sorts the information by date, and only shows the number of contributions that occurred during those dates.
...
**Answer** Now we get the contributions listed from most to least
...
**Answer** The data now shows the memo text
...
**Answer** The memos are now in order of attached money
...
**Answer** The code now shows the average and median amounts of money donated by some of these accounts, of which Trumps campaign gets the top amounts of moeny
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **Answer** This now shows the amounts of money and contributions by city
